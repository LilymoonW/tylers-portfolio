...
export default function SocialVideoEmbed({ project, embedSrc, platform }: SocialVideoEmbedProps) {
  const outHref = project.cardHref?.trim() ?? project.embedUrl
  const outLabel = platform === 'instagram' ? 'View on Instagram' : 'View on TikTok'
